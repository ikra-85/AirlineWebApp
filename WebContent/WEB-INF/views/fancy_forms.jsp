...
<table>
		<tr><th>Flight and Airplane</th><th>Pilot</th><th>Passenger</th></tr>
		<tr><td>
			<form action="AddFlight.do" method="POST">
					...
					<br> Hour of Day: <input name="hour" type="text">0 - 23 
						<br>
						Minute: <input name="minute" type="text"> 
						<br> 
			...
			<td>
				...
				<form action="CreatePilotToFlight.do" method="POST">
					...
					<br> Pilot Rank: <br> <select id="pilot_rank" name="pilot_rank">
...
</table><h2>Add Passenger to Flight</h2><form action="AddPassengerToFlight.do" method="POST">
		<table>
		<tr>
		<td>Add passenger with the ID</td>
		<td>to the Flight with the ID</td>
		</tr>
		<tr>
		...
		<td><input name="fid" type="text"></td>
			...
			<br>
			<hr>
		</form><h2>Add flight to passenger <span style="font-family: serif; font-size: 16px">(give another	ticket)</span></h2><form action="AddFlightTicketToPassenger.do" method="POST">
